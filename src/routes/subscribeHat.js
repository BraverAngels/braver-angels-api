...
router.post('/', urlencodedParser, (req, res, next) => {
    ...
    const personData = {
        ...
        language: "en",
        customFields: [
            { "Master Partisanship": leaning }
        ]
    };

    if (subscriber.org) {
        personData.customFields.push({ 'Organization': subscriber.org });
    }
    ...
    */
    fetch('https://actionnetwork.org/api/v2/forms/184c3e48-5c0d-4193-9ef1-cf4715f43ca2/submissions/', {
        method: 'POST',
